...
\usecase{RUN}{Use Gen2 Middleware}
The Operator submits a (sub)campaign which requires Gen2 Middleware
...
Certain steps in a workflow can proceed even when not all declared
inputs are present.  The Operator wants the BPS to continue with
processing for such steps providing their minimal requirements are
satisfied.
